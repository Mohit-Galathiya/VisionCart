...
fun GetAllProducts(
    ...
    val getAllProductState by viewModel.getAllProductState.collectAsStateWithLifecycle()
    val productData = getAllProductState.userData.filterNotNull()
    ...
    Scaffold(
        ...
        Column(
            ...
            when {
                ...
                getAllProductState.errorMessage != null -> {
                    Box(
                        modifier = Modifier.fillMaxSize(),
                        contentAlignment = Alignment.Center
                    ) {
